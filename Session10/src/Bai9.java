...
public class Bai9 {
    public static void main(String[] args) {
        Employee emp = new Employee("Thái Nguyễn Gia Bảo", "E001", 25000000);
        Manager mgr = new Manager("Trần Thị Quỳnh Trang", "M001", 18000000, 700000);
        Developer dev = new Developer("Cao Đăng Hoàng", "D001", 15000000, "C");
